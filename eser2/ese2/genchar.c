...
#include <unistd.h>
/*
consegna: si scriva un programma in c che sfrutti 2 diversi thread per la generazione causale di una 
stringa t di catatteri

il thread a fornisce output in N valori numerici nel range [0.9]
il thread b fornisce output in L carattrei alfabetici minuscoli [a...z]

la stringa finale dovra essere il risultato di contatemento dei risultati dei 2 thread, es: 16eaws14ndhai7taa
*/
